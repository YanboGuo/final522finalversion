 ...
 * @author jedimcc
 */
public class ShoppingCartPage extends javax.swing.JFrame implements CaretListener{
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Shopping Web", "Order", "Signout" }));
        jComboBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if(selected.toString().equals("Shopping Web"))
                   {
